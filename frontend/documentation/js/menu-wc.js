...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">humanae documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-e6ae97bb099598fc6e501fcb52f374e8"' : 'data-target="#xs-components-links-module-AppModule-e6ae97bb099598fc6e501fcb52f374e8"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-e6ae97bb099598fc6e501fcb52f374e8"' :
                                            'id="xs-components-links-module-AppModule-e6ae97bb099598fc6e501fcb52f374e8"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/CausasComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">CausasComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ParceirosComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ParceirosComponent</a>
                                            </li>
                                            <li class="link">
